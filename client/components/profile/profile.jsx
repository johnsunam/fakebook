Profile=React.createClass({
  ...
  getInitialState(){
    return{
      ...
      editmode:false,
      email:this.data && this.data.currentUser && this.data.currentUser.emails?
      this.data.currentUser.emails[0].address:"sunamjohn@gamil.com"
    }
  },
  componentDidMount(){
    ...
    return(
      <div className="row">
        ...
        <label>
            ...
            <input onChange={this.uploadFile} id="avatar" type="file" className="fileInput chang-avatar"/>
            </div>
        </label>
        </div>
        </div>
